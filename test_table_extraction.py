...
def print_comparison_results(results: Dict[str, any], pdf_name: str):
    ...
    # Transaction counts
    print(f"📈 Transaction Extraction:")
    ...
    if count_diff > 0:
        ...
        print(f"  ➡️ Same number of transactions")
    ...
    if table_data['transaction_count'] > flat_data['transaction_count']:
        table_score += 1
        print(f"  ✅ Table method extracts more transactions")
    elif flat_data['transaction_count'] > table_data['transaction_count']:
        flat_score += 1
        print(f"  ✅ Flat method extracts more transactions")
    ...
    if (table_stats['total_transactions'] > 0 and flat_stats['total_transactions'] > 0):
        ...
        if table_city_rate > flat_city_rate:
            table_score += 1
            print(f"  ✅ Table method extracts more merchant cities")
        elif flat_city_rate > table_city_rate:
            flat_score += 1
            print(f"  ✅ Flat method extracts more merchant cities")
    
    # Final recommendation
    if table_score > flat_score:
        print(f"  🥇 RECOMMENDATION: Use table extraction method")
    elif flat_score > table_score:
        print(f"  🥇 RECOMMENDATION: Use flat extraction method")
    else:
